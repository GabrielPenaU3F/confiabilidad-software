...
class DelayedSShapedTestsWithTTFFormatNtdsData(unittest.TestCase):
    ...
    def test_ntds_delayed_s_shaped_least_squares_a_parameter_is_26_comma_715478(self):
        a = DelayedSShapedTestsWithTTFFormatNtdsData.fit.get_lsq_parameters()[0]
    ...
    def test_ntds_delayed_s_shaped_least_squares_b_parameter_is_0_comma_021213(self):
        b = DelayedSShapedTestsWithTTFFormatNtdsData.fit.get_lsq_parameters()[1]
    ...
    def test_ntds_delayed_s_shaped_maximum_likelihood_a_parameter_is_27_comma_491544(self):
        a = DelayedSShapedTestsWithTTFFormatNtdsData.fit.get_ml_parameters()[0]
