...
class GoelOkumotoTestsWithGroupedFailuresPerDayFormatMixedWaterfallAgileData(unittest.TestCase):
    ...
    def test_mixed_waterfall_agile_goel_okumoto_maximum_likelihood_a_parameter_is_1373_comma_290255(self):
        a = GoelOkumotoTestsWithGroupedFailuresPerDayFormatMixedWaterfallAgileData.fit.get_ml_parameters()[0]
    ...
    def test_mixed_waterfall_agile_goel_okumoto_maximum_likelihood_b_parameter_is_0_comma_004957(self):
        b = GoelOkumotoTestsWithGroupedFailuresPerDayFormatMixedWaterfallAgileData.fit.get_ml_parameters()[1]
    ...
    def test_mixed_waterfall_agile_goel_okumoto_maximum_likelihood_prr_is_9_comma_036989(self):
        prr = GoelOkumotoTestsWithGroupedFailuresPerDayFormatMixedWaterfallAgileData.fit.get_prr_ml()
    ...
    def test_mixed_waterfall_agile_goel_okumoto_aic_is_minus_777_comma_398430(self):
        aic = GoelOkumotoTestsWithGroupedFailuresPerDayFormatMixedWaterfallAgileData.fit.get_aic()
