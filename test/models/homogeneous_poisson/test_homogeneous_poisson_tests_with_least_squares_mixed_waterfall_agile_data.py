...
class HomogeneousPoissonTestsWithLeastSquaresMixedWaterfallAgileData(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.fit = ModelFitter().fit('poisson', 'mixed-waterfall-agile', initial_approx=0.5, lsq_only=True)

    def test_mixed_waterfall_agile_homogeneous_poisson_least_squares_a_parameter_is_4_comma_805753(self):
        a = HomogeneousPoissonTestsWithLeastSquaresMixedWaterfallAgileData.fit.get_lsq_parameters()[0]
    ...
    def test_mixed_waterfall_agile_homogeneous_poisson_least_squares_prr_is_18_comma_304389(self):
        prr = HomogeneousPoissonTestsWithLeastSquaresMixedWaterfallAgileData.fit.get_prr_lsq()
