...
class HomogeneousPoissonTestsWithGroupedFailuresPerDayFormatMaximumLikelihoodMixedWaterfallAgileData(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.fit = ModelFitter().fit('poisson', 'mixed-waterfall-agile', initial_approx=0.5)

    def test_mixed_waterfall_agile_homogeneous_poisson_maximum_likelihood_a_parameter_is_4_comma_239234(self):
        a = HomogeneousPoissonTestsWithGroupedFailuresPerDayFormatMaximumLikelihoodMixedWaterfallAgileData.fit.get_ml_parameters()[0]
    ...
    def test_mixed_waterfall_agile_homogeneous_poisson_maximum_likelihood_prr_is_32_comma_397142(self):
        prr = HomogeneousPoissonTestsWithGroupedFailuresPerDayFormatMaximumLikelihoodMixedWaterfallAgileData.fit.get_prr_ml()
    ...
    def test_mixed_waterfall_agile_homogeneous_poisson_aic_is_1366_comma_889271(self):
        aic = HomogeneousPoissonTestsWithGroupedFailuresPerDayFormatMaximumLikelihoodMixedWaterfallAgileData.fit.get_aic()
