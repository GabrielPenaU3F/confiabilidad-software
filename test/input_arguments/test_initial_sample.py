...
class TestInitialSample(unittest.TestCase):
    ...
    def test_ntds_goel_okumoto_with_a_partial_dataset_from_sample_10(self):
        a = self.__class__.ntds_go_fit_from_sample_10.get_ml_parameters()[0]
        b = self.__class__.ntds_go_fit_from_sample_10.get_ml_parameters()[1]
    ...
    def test_ntds_goel_okumoto_with_a_partial_dataset_from_sample_0_should_behave_as_if_not_specified(self):
        a = self.__class__.ntds_go_fit_from_sample_0.get_ml_parameters()[0]
        b = self.__class__.ntds_go_fit_from_sample_0.get_ml_parameters()[1]
    ...
    def test_mixed_ds_with_a_partial_dataset_from_sample_40(self):
        a = self.__class__.mixed_ds_fit_from_sample_40.get_ml_parameters()[0]
        b = self.__class__.mixed_ds_fit_from_sample_40.get_ml_parameters()[1]
    ...
    def test_mixed_ds_with_a_partial_dataset_from_sample_0_should_behave_as_if_not_specified(self):
        a = self.__class__.mixed_ds_fit_from_sample_0.get_ml_parameters()[0]
        b = self.__class__.mixed_ds_fit_from_sample_0.get_ml_parameters()[1]
