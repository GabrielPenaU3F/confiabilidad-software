...
params_ds_mv = ds.estimar_parametros_por_maxima_verosimilitud_tiempo_hasta_la_falla(x, params_ds_lsq,
...
if params_ds_mv is not None:
        ax.plot(x, ds.calcular_numero_medio_de_fallas(x, params_ds_mv[0], params_ds_mv[1]),
