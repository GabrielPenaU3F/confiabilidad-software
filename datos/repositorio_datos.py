...
class RepositorioDatos:
    ...
    datos_proyecto_x = [0, 36, 104, 118, 135, 142, 146, 147, 215, 217, 224, 231, 231, 231,
    ...
    @classmethod
    def proveer_datos_observados_proyecto_X(cls):

        datos_observados = []
        for k in range(len(cls.datos_proyecto_x)):
            datos_observados.append(Dato(k, cls.datos_proyecto_x[k]))
