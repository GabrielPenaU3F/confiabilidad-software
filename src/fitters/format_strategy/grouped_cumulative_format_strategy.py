...
class GroupedCumulativeFormatStrategy(FormatStrategy):
    ...
    def __init__(self, data, model):
        ...
        self.execute_ml_function = self.model.estimate_grouped_cumulative_parameters_by_maximum_likelihood
    ...
    def fit_model(self, **kwargs):
        ...
        ml_params = self.execute_ml_function(times, cumulative_failures, lsq_params, solving_method='krylov')
